...
FOOTNOTES = {
    ...
    "37": r"\href{http://www.techterms.com/definition/mainframe}{http://www.techterms.com/definition/mainframe}",
    ...
    "48": r"\href{http://www.techterms.com/definition/wan}{http://www.techterms.com/definition/wan}"
}