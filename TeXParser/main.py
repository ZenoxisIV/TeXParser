...
def main():
    ...
    build_TeX = [
        ...
        NEWLINE,
        ''.join([docu.import_package(pkg) for pkg in ["amssymb", "float", "url", "latexsym", "setspace", 
                                                      "enumitem", "makecell", "multicol", "multirow", 
                                                      "lastpage", "mdframed", "titlesec", "fancyhdr", 
                                                      "newfloat", "graphicx", "array"]]),
        NEWLINE,
